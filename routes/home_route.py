        ...
        hyperparameters.update(
            {
                ...
                "activation_function": request.form.get("cnn-activation-function"),
        ...
        hyperparameters.update(
            {
                ...
                "epsilon": request.form.get("svm-epsilon", type=float),
        ...
        hyperparameters.update(
            {
                ...
                "optimizer": request.form.get("vit-optimizer"),
                "weight_decay": request.form.get("vit-weight-decay", type=float),
                "dropout_rate": request.form.get("vit-dropout-rate", type=float),
                "patch_size": request.form.get("vit-patch-size", type=int),
                "hidden_size": request.form.get("vit-hidden-size", type=int),
                "num_layers": request.form.get("vit-num-layers", type=int),
                "num_heads": request.form.get("vit-num-heads", type=int),
                "mlp_size": request.form.get("vit-mlp-size", type=int),
            }
        )
